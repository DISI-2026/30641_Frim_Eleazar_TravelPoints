...
* The original package name 'ro.utcn.travelpoints.travelpoints-backend' is invalid and this project uses 'ro.utcn.travelpoints.travelpoints_backend' instead.
